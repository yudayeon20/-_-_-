...
Streamlit Cloud:
    Main file path      streamlit_app.py     (저장소 루트)
    Settings → Secrets  DATA_GO_KR_SERVICE_KEY = "발급받은_인증키"
...
ROOT = Path(__file__).resolve().parent   # 저장소 루트
